...
namespace Shop
{
    ...
    >>>>>>> parent of 8d6f9c2 (Add UseDirectoryBrowser)
            ...
            // настройка для статических файлов, позволяющая кешировать их на период 604800 сек - 7 дней (файл считается актуальным в течение 7 дней (не надо скачивать повторно с сервера))
